<?php include 'head.include.php'; ?>
			...
			<div role="main" class="inner cover">
				<h1 class="cover-index cover-heading">Error</h1>
				<p><?= $errorMsg; ?></p>
				...
				<form id="form" action="register" method="post">
					<input type="text" id="name" name="name"<?= isset($name) ? " value=$name" : '' ; ?> placeholder="Choose a name" class="form-control" required />
					<input type="email" id="email" name="email"<?= isset($email) ? " value=$email" : '' ; ?> placeholder="Enter your email" class="form-control" required />
